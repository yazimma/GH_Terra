...
__IO_REG8    (RTC_WPR,     0x5159, __READ_WRITE);
/* Alarm A register 1 */
#ifdef __IAR_SYSTEMS_ICC__
typedef struct
{
...
typedef struct
{
  ...
  unsigned char S325        : 1;
  unsigned char S326        : 1;
...
#define LCD_RAM13_S325           LCD_RAM13_bit.S325
#define LCD_RAM13_S326           LCD_RAM13_bit.S326
...
#define MASK_LCD_RAM13_S325      0x20
#define MASK_LCD_RAM13_S326      0x40
